...
inline void EmptyOnChangeState(TAnalogDevice *Device, unsigned int Value) {};
...
public:
    ...
    TAnalogDevice(TApplication *App, uint8_t _Pin) : TControl(App)
    {
        Pin = _Pin;
        pinMode(Pin, INPUT);
    };
...
inline TAnalogDevice::~TAnalogDevice()
{
}
